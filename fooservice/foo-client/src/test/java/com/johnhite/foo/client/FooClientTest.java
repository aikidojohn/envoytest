...
public class FooClientTest {
	...
	public void test() throws Exception{
		...
		JerseyClient jerseyClient = new JerseyClientBuilder()
				...
				.sslContext(sc)
				.build();
		FooClient client = new FooClient("https://localhost:7443/", jerseyClient);
		System.out.println(mapper.writerWithDefaultPrettyPrinter().writeValueAsString(client.getFoo()));
	}
}
